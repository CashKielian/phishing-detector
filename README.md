...
* **String Sanitization**: Utilizing '.lower()' and '.strip()' to prevent punctuation rom breaking key matching and change all letter case's accordingly.
* **Nested Loop Structures**: Implementing an outer loop to iterate through text inputs and an inner loop to evaluate data against a security backlist.
